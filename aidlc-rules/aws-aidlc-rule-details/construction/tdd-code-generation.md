...
- [ ] In autonomous mode: auto-approve and proceed. Do not wait for user to approve all 3 TDD plan files
...
- [ ] Record TDD selection for this unit in `aidlc-state.md` (e.g., `| {unit-name} | TDD | Code Planning Complete |`)
